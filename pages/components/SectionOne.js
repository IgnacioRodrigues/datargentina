        ...
        <div className="relative w-full">
            ...
            <div className="flags_container">
              <div className="flags_background">
                <div className="slider_wrapper">
                  ...
                  <img src="./images/borges.jpg" alt="Jorge Luis Borges" className="slider_img shadow" style={{width: 120 + 'px', height: 120 + 'px', left: 1340 + 'px', top: 58 + 'px', animationDelay: -154475 + 'ms'}} />
                  <img src="./images/favaloro.jpg" alt="René Favaloro" className="slider_img shadow" style={{width: 120 + 'px', height: 120 + 'px', left: 1340 + 'px', top: 173 + 'px', animationDelay: -108915 + 'ms'}} />
                  <img src="./images/cortazar.jpeg" alt="Julio Cortázar" className="slider_img shadow" style={{width: 120 + 'px', height: 120 + 'px', left: 1340 + 'px', top: 88 + 'px', animationDelay: -180305 + 'ms'}} />
                  <img src="./images/gardel.jpg" alt="Carlos Gardel" className="slider_img shadow" style={{width: 120 + 'px', height: 120 + 'px', left: 1340 + 'px', top: 325 + 'px', animationDelay: -91627 + 'ms'}} />
                  <img src="./images/maradona.jpg" alt="Diego Armando Maradona" className="slider_img shadow" style={{width: 120 + 'px', height: 120 + 'px', left: 1340 + 'px', top: 51 + 'px', animationDelay: -63458 + 'ms'}} />
                  <img src="./images/fangio.png" alt="Juan Manuel Fangio" className="slider_img shadow" style={{width: 120 + 'px', height: 120 + 'px', left: 1340 + 'px', top: 43 + 'px', animationDelay: -7627 + 'ms'}} />
          ...
          <style jsx>{`
            ...
            .slider_img {
              ...
              -webkit-animation-name: slider_moving;
