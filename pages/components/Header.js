      ...
      <div className="relative z-10 max-w-screen-lg xl:max-w-screen-xl mx-auto">
        <div className="py-6 flex items-center justify-between sm:mx-0px-4 px-4">
          ...
          <div className="flex space-x-6 sm:space-x-10">
            <a className="text-base leading-6 font-medium hover:text-gray-600 transition-colors duration-200" href="#">
              <span className="sm:hidden">Docs</span>
              <span className="hidden sm:inline">Documentación</span>
            </a>
            <a href="https://github.com/ignaciorodrigues/datargentina" className="text-gray-400 hover:text-gray-500 transition-colors duration-200">
              <span className="sr-only">Data Argentina en GitHub</span>
