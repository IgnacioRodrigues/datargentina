      ...
      <div className="px-4 sm:px-6 md:px-8 mb-14 sm:mb-20 xl:mb-8">
        <div className="flex flex-col justify-center items-center md:justify-start md:flex-row md:items-start">
          ...
          <div className="flex-auto mt-10 md:mt-0 md:pl-10 text-center md:text-left ">
            ...
            <p class="max-w-screen-lg text-lg sm:text-2xl sm:leading-10 font-normal mb-10 sm:mb-11">Biblioteca de libre acceso la cual contiene información sobre la República Argentina. Entre ellos se encuentrán <span className="font-medium">fechas relevantes</span>, <span className="font-medium">hechos históricos</span>, <span className="font-medium">datos geográficos</span>, <span className="font-medium">biografías de personas</span>, <span className="font-medium">cultura</span>, <span className="font-medium">datos naturales</span> y mucho más.</p>
