          ...
          <section className="flex">
            <div className="cursor-pointer w-full relative text-white overflow-hidden rounded-3xl flex shadow transition rounded-3xl bg-gray-50 hover:shadow-2xl hover:bg-gray-100">
              <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                ...
                <h2 className="font-evangelina text-3xl text-gray-800 font-semibold mt-2 mb-1 text-shadow">Hechos historicos</h2>
          ...
          <section className="flex">
            <div className="cursor-pointer w-full relative text-white overflow-hidden rounded-3xl flex shadow transition rounded-3xl bg-gray-50 hover:shadow-2xl hover:bg-gray-100">
              <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                ...
                <h2 className="font-evangelina text-3xl text-gray-800 font-semibold mt-2 mb-1 text-shadow">Datos geográficos</h2>
          ...
          <section className="flex">
            <div className="cursor-pointer w-full relative text-white overflow-hidden rounded-3xl flex shadow transition rounded-3xl bg-gray-50 hover:shadow-2xl hover:bg-gray-100">
              <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                ...
                <h2 className="font-evangelina text-3xl text-gray-800 font-semibold mt-2 mb-1 text-shadow">Biografías</h2>
          ...
          <section className="flex">
            <div className="cursor-pointer w-full relative text-white overflow-hidden rounded-3xl flex shadow transition rounded-3xl bg-gray-50 hover:shadow-2xl hover:bg-gray-100">
              <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                ...
                <h2 className="font-evangelina text-3xl text-gray-800 font-semibold mt-2 mb-1 text-shadow">Fechas importantes</h2>
          ...
          <section className="flex">
            <div className="cursor-pointer w-full relative text-white overflow-hidden rounded-3xl flex shadow transition rounded-3xl bg-gray-50 hover:shadow-2xl hover:bg-gray-100">
              <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                ...
                <h2 className="font-evangelina text-3xl text-gray-800 font-semibold mt-2 mb-1 text-shadow">Centros educativos</h2>
          ...
          <section className="flex">
            <div className="cursor-pointer w-full relative text-white overflow-hidden rounded-3xl flex shadow transition rounded-3xl bg-gray-50 hover:shadow-2xl hover:bg-gray-100">
              <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                ...
                <h2 className="font-evangelina text-3xl text-gray-800 font-semibold mt-2 mb-1 text-shadow">Hospitales, Guardias y Clinicas</h2>
          ...
          <section className="flex">
            <div className="cursor-pointer w-full relative text-white overflow-hidden rounded-3xl flex shadow transition rounded-3xl bg-gray-50 hover:shadow-2xl hover:bg-gray-100">
              <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                ...
                <h2 className="font-evangelina text-3xl text-gray-800 font-semibold mt-2 mb-1 text-shadow">Medios de comunicación</h2>
          ...
          <section className="flex">
            <div className="cursor-pointer w-full relative text-white overflow-hidden rounded-3xl flex shadow transition rounded-3xl bg-gray-50 hover:shadow-2xl hover:bg-gray-100">
              <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                ...
                <h2 className="font-evangelina text-3xl text-gray-800 font-semibold mt-2 mb-1 text-shadow">Instituciones Gubernamentales</h2>
          ...
          <section className="flex">
            <div className="cursor-pointer w-full relative text-white overflow-hidden rounded-3xl flex shadow transition rounded-3xl bg-gray-50 hover:shadow-2xl hover:bg-gray-100">
              <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                ...
                <h2 className="font-evangelina text-3xl text-gray-800 font-semibold mt-2 mb-1 text-shadow">Política</h2>
          ...
          <section className="flex">
            <div className="cursor-pointer w-full relative text-white overflow-hidden rounded-3xl flex shadow transition rounded-3xl bg-gray-50 hover:shadow-2xl hover:bg-gray-100">
              <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                ...
                <h2 className="font-evangelina text-3xl text-gray-800 font-semibold mt-2 mb-1 text-shadow">Flora y Fauna</h2>
          ...
          <section className="flex">
            <div className="cursor-pointer w-full relative text-white overflow-hidden rounded-3xl flex shadow transition rounded-3xl bg-gray-50 hover:shadow-2xl hover:bg-gray-100">
              <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                ...
                <h2 className="font-evangelina text-3xl text-gray-800 font-semibold mt-2 mb-1 text-shadow">Deporte</h2>
          ...
          <section className="flex">
            <div className="cursor-pointer w-full relative text-white overflow-hidden rounded-3xl flex shadow transition rounded-3xl bg-gray-50 hover:shadow-2xl hover:bg-gray-100">
              <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                ...
                <h2 className="font-evangelina text-3xl text-gray-800 font-semibold mt-2 mb-1 text-shadow">Entretenimiento</h2>
          ...
          <section className="flex">
            <div className="cursor-pointer w-full relative text-white overflow-hidden rounded-3xl flex shadow transition rounded-3xl bg-gray-50 hover:shadow-2xl hover:bg-gray-100">
              <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                ...
                <h2 className="font-evangelina text-3xl text-gray-800 font-semibold mt-2 mb-1 text-shadow">Símbolos nacionales</h2>
          ...
          <section className="flex">
            <div className="cursor-pointer w-full relative text-white overflow-hidden rounded-3xl flex shadow transition rounded-3xl bg-gray-50 hover:shadow-2xl hover:bg-gray-100">
              <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                ...
                <h2 className="font-evangelina text-3xl text-gray-800 font-semibold mt-2 mb-1 text-shadow">Economía</h2>
          ...
          <section className="flex">
            <div className="cursor-pointer w-full relative text-white overflow-hidden rounded-3xl flex shadow transition rounded-3xl bg-gray-50 hover:shadow-2xl hover:bg-gray-100">
              <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                ...
                <h2 className="font-evangelina text-3xl text-gray-800 font-semibold mt-2 mb-1 text-shadow">Población y cultura</h2>
