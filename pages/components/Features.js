            ...
            <div className="w-full relative text-white overflow-hidden rounded-3xl flex shadow-lg transition hover:shadow-2xl">
              <div className="w-full flex md:flex-col bg-gradient-to-br from-blue-400 to-blue-500">
                <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                  ...
                  <p className="font-medium text-violet-100 text-shadow mb-4">Explora la historia, datos, sucesos e información relevante.</p>
            ...
            <div className="w-full relative text-white overflow-hidden rounded-3xl flex shadow-lg transition hover:shadow-2xl">
              <div className="w-full flex md:flex-col bg-gradient-to-br from-purple-500 to-purple-700">
                <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                  ...
                  <p className="font-medium text-violet-100 text-shadow mb-4">Accede a información geográfica del territorio argentino.</p>
            ...
            <div className="w-full relative text-white overflow-hidden rounded-3xl flex shadow-lg transition hover:shadow-2xl">
              <div className="w-full flex md:flex-col bg-gradient-to-br from-pink-500 to-pink-700">
                <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                  ...
                  <p className="font-medium text-violet-100 text-shadow mb-4">Conoce las biografías de las personas que hicieron historia.</p>
            ...
            <div className="w-full relative text-white overflow-hidden rounded-3xl flex shadow-lg transition hover:shadow-2xl">
              <div className="w-full flex md:flex-col bg-gradient-to-br from-yellow-400 to-yellow-600">
                <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                  ...
                  <p className="font-medium text-violet-100 text-shadow mb-4">Accede a fechas patrias, ferias y fechas claves de la Argentina.</p>
            ...
            <div className="w-full relative text-white overflow-hidden rounded-3xl flex shadow-lg transition hover:shadow-2xl">
              <div className="w-full flex md:flex-col bg-gradient-to-br from-red-500 to-red-700">
                <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                  ...
                  <p className="font-medium text-violet-100 text-shadow mb-4">Conoce los centros educativos físicos y digitales de la Argentina.</p>
            ...
            <div className="w-full relative text-white overflow-hidden rounded-3xl flex shadow-lg transition hover:shadow-2xl">
              <div className="w-full flex md:flex-col bg-gradient-to-br from-green-500 to-green-700">
                <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                  ...
                  <p className="font-medium text-violet-100 text-shadow mb-4">Accede a los centros médicos del todo el país.</p>
            ...
            <div className="w-full relative text-white overflow-hidden rounded-3xl flex shadow-lg transition hover:shadow-2xl">
              <div className="w-full flex md:flex-col bg-gradient-to-br from-pink-500 to-pink-700">
                <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                  ...
                  <p className="font-medium text-violet-100 text-shadow mb-4">Conoce los medios de comunicación de la Argentina.</p>
                  <a className="bg-white text-pink-700 rounded-xl p-4 font-bold hover:bg-gray-100" href="#">Explorar</a>
                </div>
              </div>
            </div>
            ...
            <div className="w-full relative text-white overflow-hidden rounded-3xl flex shadow-lg transition hover:shadow-2xl">
              <div className="w-full flex md:flex-col bg-gradient-to-br from-blue-400 to-blue-500">
                <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                  ...
                  <p className="font-medium text-violet-100 text-shadow mb-4">Conoce todos sobre las Instituciones Gubernamentales de la Argentina.</p>
                  <a className="bg-white text-blue-500 rounded-xl p-4 font-bold hover:bg-gray-100" href="#">Explorar</a>
                </div>
              </div>
            </div>
            ...
            <div className="w-full relative text-white overflow-hidden rounded-3xl flex shadow-lg transition hover:shadow-2xl">
              <div className="w-full flex md:flex-col bg-gradient-to-br from-purple-500 to-purple-700">
                <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                  ...
                  <p className="font-medium text-violet-100 text-shadow mb-4">Descubre todo sobre la política Argentina, partidos políticos y su historia.</p>
                  <a className="bg-white text-purple-700 rounded-xl p-4 font-bold hover:bg-gray-100" href="#">Explorar</a>
                </div>
              </div>
            </div>
            ...
            <div className="w-full relative text-white overflow-hidden rounded-3xl flex shadow-lg transition hover:shadow-2xl">
              <div className="w-full flex md:flex-col bg-gradient-to-br from-green-500 to-green-700">
                <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                  ...
                  <p className="font-medium text-violet-100 text-shadow mb-4">Descubre la diversidad natural de todo el territorio argentino.</p>
                  <a className="bg-white text-green-700 rounded-xl p-4 font-bold hover:bg-gray-100" href="#">Explorar</a>
                </div>
              </div>
            </div>
            ...
            <div className="w-full relative text-white overflow-hidden rounded-3xl flex shadow-lg transition hover:shadow-2xl">
              <div className="w-full flex md:flex-col bg-gradient-to-br from-yellow-400 to-yellow-600">
                <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                  ...
                  <p className="font-medium text-violet-100 text-shadow mb-4">Descubre los clubes, torneos y campeonatos de todos los deportes.</p>
                  <a className="bg-white text-yellow-600 rounded-xl p-4 font-bold hover:bg-gray-100" href="#">Explorar</a>
                </div>
              </div>
            </div>
            ...
            <div className="w-full relative text-white overflow-hidden rounded-3xl flex shadow-lg transition hover:shadow-2xl">
              <div className="w-full flex md:flex-col bg-gradient-to-br from-red-500 to-red-700">
                <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                  ...
                  <p className="font-medium text-violet-100 text-shadow mb-4">Conoce los lugares de entretenimiento, centros recreativos, teatros y más.</p>
                  <a className="bg-white text-red-700 rounded-xl p-4 font-bold hover:bg-gray-100" href="#">Explorar</a>
                </div>
              </div>
            </div>
            ...
            <div className="w-full relative text-white overflow-hidden rounded-3xl flex shadow-lg transition hover:shadow-2xl">
              <div className="w-full flex md:flex-col bg-gradient-to-br from-blue-400 to-blue-500">
                <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                  ...
                  <p className="font-medium text-violet-100 text-shadow mb-4">Conoce todos símbolos patrios de la República Argentina.</p>
                  <a className="bg-white text-blue-500 rounded-xl p-4 font-bold hover:bg-gray-100" href="#">Explorar</a>
                </div>
              </div>
            </div>
            ...
            <div className="w-full relative text-white overflow-hidden rounded-3xl flex shadow-lg transition hover:shadow-2xl">
              <div className="w-full flex md:flex-col bg-gradient-to-br from-pink-500 to-pink-700">
                <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                  ...
                  <p className="font-medium text-violet-100 text-shadow mb-4">Accede a información crucial sobre la economía Argentina.</p>
                  <a className="bg-white text-pink-700 rounded-xl p-4 font-bold hover:bg-gray-100" href="#">Explorar</a>
                </div>
              </div>
            </div>
            ...
            <div className="w-full relative text-white overflow-hidden rounded-3xl flex shadow-lg transition hover:shadow-2xl">
              <div className="w-full flex md:flex-col bg-gradient-to-br from-green-500 to-green-700">
                <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-8">
                  ...
                  <p className="font-medium text-violet-100 text-shadow mb-4">Accede a información sobre la población y la diversidad cultural del país.</p>
                  <a className="bg-white text-green-700 rounded-xl p-4 font-bold hover:bg-gray-100" href="#">Explorar</a>
                </div>
              </div>
            </div>
